...
$(function(){
	...
	if(action == 'comment'){
		...
		<div class="follow">
			<div class="follower">
			<?php if(!empty($user_info)): ?><!-- text循环 -->
				<?php if(is_array($user_info)): foreach($user_info as $key=>$data): ?><div class="followers">
						<a class="get_user_info" u_id="<?php echo ($data["user_id"]); ?>" href="javascript:;"><img class="pic" src="<?php echo ($data["pic"]); ?>" /></a>
						<span class="user_name"><a class="a" href="__URL__/user_info"><?php echo ($data["user_name"]); ?></a></span>
						<span class="date"><?php echo ($data["add_time"]); ?></span>
