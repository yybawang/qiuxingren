	...
	<div class="left">
		<?php if(is_array($content)): foreach($content as $key=>$data): ?><div class="L_content">
			...
			<?php if($data["pic"] != null): ?><div class="L_user">
				<img class="pic" src="<?php echo ($data["pic"]); ?>" /><span class="former_user_name"><a u_id="<?php echo ($data["former_user_id"]); ?>" title="发送小纸条" href="javascript:void(0)"><?php echo ($data["former_user_name"]); ?></a></span>
			</div><?php endif; ?>
			<div class="L_text">
