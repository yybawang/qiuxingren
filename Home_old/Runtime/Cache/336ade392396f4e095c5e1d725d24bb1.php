...
$(function(){
	...
	if(action == 'comment'){
		...
		<div class="right">
			<div class="righter">
				<form action="__URL__/repwd" method="post">
					
					<div class="old_pwd">&emsp;&emsp;&emsp;&emsp;原密码：<input type="password" name="old_pwd" /><span class="old_span"></span></div>
					<div class="new_pwd">&emsp;&emsp;&emsp;&emsp;新密码：<input type="password" name="new_pwd" /><span class="new_span"></span></div>
					<div class="new_pwd">再次输入新密码：<input type="password" name="new_pwd2" /><span class="new_span2"></span></div>
