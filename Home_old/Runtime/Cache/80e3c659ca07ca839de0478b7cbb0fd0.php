...
<div class="zone_content">
	<div class="left">
		<div class="order">
			<ul>
				<li class="tips">排序：</li>
				<li class="by by_time on"><a <?php if($_GET['by']!= 'add_time'): ?>href="<?php echo (__URL__); ?>/<?php echo (ACTION_NAME); ?>/by/add_time"<?php endif; ?>>时间</a></li>
				<li class="by by_up"><a <?php if($_GET['by']!= 'up'): ?>href="<?php echo (__URL__); ?>/<?php echo (ACTION_NAME); ?>/by/up"<?php endif; ?>>人气</a></li>
				<!--<li class="tips">选项：</li>
				<li class="by op_hasname" <?php if($_GET['option']== 'hasname'): ?>class="on"<?php endif; ?> ><a <?php if($_GET['option']!= 'hasname'): ?>href="__SELF__/option/hasname"<?php endif; ?>>没匿名</a></li>-->
		...
		<?php if(is_array($content)): foreach($content as $key=>$data): ?><div class="L_content">
			...
			<?php if($data["pic"] != null): ?><div class="L_user">
				...
				<span class="former_user_name"><a u_id="<?php echo ($data["former_user_id"]); ?>" title="发送小纸条" href="javascript:void(0)"><?php echo ($data["former_user_name"]); ?></a></span>
			</div><?php endif; ?>
			<div class="L_text">
