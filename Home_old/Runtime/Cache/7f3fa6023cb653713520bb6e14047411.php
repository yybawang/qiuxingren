	...
	<div class="left">
		<div class="L_content">
			...
			<?php if($data["pic"] != null): ?><div class="L_user">
				<img class="pic" src="<?php echo ($data["pic"]); ?>" /><span class="former_user_name"><a u_id="<?php echo ($data["former_user_id"]); ?>" title="发送小纸条" href="javascript:;"><?php echo ($data["former_user_name"]); ?></a></span>
			</div><?php endif; ?>
			<div class="L_text">
